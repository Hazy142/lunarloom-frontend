...
export const metadata: Metadata = {
    title: 'Erfahrungsberichte – Lunar Loom',
    description: 'Erfahrungsberichte und Testimonials von Klienten',
};

export default async function ErfahrungsberichtePage() {
    const page = await getPageBySlug('erfahrungsberichte');
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <article className="bg-gradient-to-br from-purple-900/40 to-indigo-900/40 rounded-xl p-8 md:p-12 border border-purple-500/30">
                        ...
                        <div
                         ...
                         prose-blockquote:border-purple-500 prose-blockquote:text-purple-300 prose-blockquote:italic"
